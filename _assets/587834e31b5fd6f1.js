(self["webpackChunk_canva_web"] = self["webpackChunk_canva_web"] || []).push([
  [86064],
  {
    /***/ 293444: function (_, __, __webpack_require__) {
      ...
      (function (__c) {
        var Vbc;
        __c.h1 = function (a, b, c) {
          return new __c.sb(a, c ? __c.ub(c) : void 0, __c.Jaa, {
            ignoreTag: !0,
          }).format(Object.fromEntries(Object.entries(b)));
        };
        __c.Ubc = function (a, b) {
          __c.u(!0);
          __c.u(!0);
          __c.u(!0);
          const { ka: c, a: d, b: e } = __c.us(a),
            { ka: f, a: g, b: h } = __c.us(b);
          a = (c + f) / 2;
          ...
          var k = d * (1 + b),
            ...
            n = Math.hypot(l, h);
          b = (m + n) / 2;
          var p = __c.Hs((Math.atan2(e, k) * 180) / Math.PI);
          const q = __c.Hs((Math.atan2(h, l) * 180) / Math.PI);
